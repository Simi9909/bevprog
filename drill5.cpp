...
int main()
{
    ...
    string s = "ape"; string c1 = "fool"; if (true) cout << "9. Success!\n"; 
    ...
    vector<char> v4(5); for (int i=0; i<=v.size(); ++i){} cout << "14. Success!\n"; 
    ...
    vector<int> v5(5); for (int i=0; i<=v.size(); ++i){} cout << "19. Success!\n"; 
